...
import { 
  ...
  Bell, FileText, Settings, HelpCircle, Calendar, Wallet, Shield
} from 'lucide-react';
...
export const Sidebar: React.FC = () => {
  ...
  const entrepreneurItems = [
    ...
    { to: '/wallet', icon: <Wallet size={20} />, text: 'Capital Ledger' },
    { to: '/security-center', icon: <Shield size={20} />, text: 'Security Center' }, // ADDED FOR MILESTONE 6
  ];
